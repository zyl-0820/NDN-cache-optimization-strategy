...
void hash(unsigned char result, enum enum_HashAlgorithm algorithm,uint16_t base,struct uint8_buffer_s data,uint32_t max,packet_descriptor_t* pd, lookup_table_t** tables);
